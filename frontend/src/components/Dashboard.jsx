...
class DashboardAPI {
  ...
  async getOverallStats() {
    try {
      ...
      const workingDaysThisMonth = this.calculateWorkingDays(
        currentYear,
        currentMonth
      );
  ...
  async getRecentActivities() {
    try {
      ...
      if (stcData.success && stcData.data) {
        const stcCandidates = Array.isArray(stcData.data)
          ? stcData.data.slice(0, 3)
          : [];
      ...
      if (wtcData.success && wtcData.data) {
        const wtcCandidates = Array.isArray(wtcData.data)
          ? wtcData.data.slice(0, 3)
          : [];
      ...
      if (nonRailwayData.success && nonRailwayData.data) {
        const nonRailwayCandidates = Array.isArray(nonRailwayData.data)
...
function Dashboard() {
  ...
  const loadDashboardData = async () => {
    ...
    try {
      const [categoriesRes, distributionRes, statsRes, activitiesRes] =
        await Promise.all([
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600 mt-2">
                Comprehensive overview of training programs and candidate
                statistics
              </p>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-2xl font-bold text-gray-900">
                    {overallStats.totalCandidates.toLocaleString()}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-4 bg-orange-50 rounded-lg border-l-4 border-orange-500">
                ...
                <p className="text-sm text-gray-600 mt-3">
                  General training programs for non-railway personnel
                </p>
              </div>
