...
const Navbar = () => {
  ...
  // Search items for dropdown suggestions
  const searchItems = [
    { name: 'STC Management', path: '/stc-management', category: 'Management' },
    ...
    { name: 'Non-Railway Candidate', path: '/non-railway-form', category: 'Add' },
    { name: 'Non Railway Form', path: '/non-railway-form', category: 'Forms' },
    { name: 'Manage Candidate', path: '/manage-candidate', category: 'Management' },
    { name: 'Candidate Management', path: '/manage-candidate', category: 'Management' },
    { name: 'Dashboard', path: '/dashboard', category: 'Navigation' },
    { name: 'Home', path: '/', category: 'Navigation' },
    { name: 'Trainee Management', path: '/manage-candidate', category: 'Management' },
    { name: 'Railway Training', path: '/stc-management', category: 'Training' },
    { name: 'Workshop Training', path: '/wtc', category: 'Training' },
    { name: 'Training Center', path: '/stc-management', category: 'Training' }
  ];
  ...
  const handleSearch = (e) => {
    ...
    if (searchQuery.trim()) {
      ...
      if (exactMatch && exactMatch.path !== '#') {
        // Navigate to exact match using React Router
        navigate(exactMatch.path);
      } else if (searchResults.length > 0) {
        // Navigate to first result using React Router
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <img src={nationalEmblem} alt="National Emblem" className="w-16 h-16" />
            ...
            <div className="flex items-center space-x-2 relative" ref={searchDropdownRef}>
            ...
            <div className="flex items-center space-x-4">
              {/* User badge */}
              <div className="flex items-center gap-2 px-3 py-1 rounded bg-orange-50 text-orange-700 text-xs font-semibold border border-orange-200 capitalize">
