    ...
    <nav className="bg-white/70 backdrop-blur-md shadow-md sticky top-0 z-50 border-b border-gray-200">
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              onClick={logout}
              className="flex items-center gap-1 px-3 py-1 rounded-md text-sm font-medium text-white bg-red-600 hover:bg-red-700 transition"
            >
      ...
      <div className="md:hidden border-t border-gray-200">
        <div className="px-4 py-2 space-y-1">
          ...
          <Link
            to="/stc-form"
            className="flex items-center px-2 py-1 text-sm text-gray-700 hover:bg-blue-50 rounded"
          >
            <Plus className="w-4 h-4 mr-2" />
            STC Candidate
          </Link>
