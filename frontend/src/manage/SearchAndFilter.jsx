      ...
      <div className="flex items-center justify-between mb-4">
        ...
        {hasActiveFilters && (
          <button
            ...
            className="flex items-center space-x-1 text-sm text-gray-500 hover:text-pink-500 transition-colors"
          >
            <X className="h-4 w-4" />
            <span>Clear all</span>
          </button>
...
const baseInputClasses = `
  ...
  focus:border-pink-500 focus:ring-4 focus:ring-pink-100 focus:shadow-lg
  transition-all duration-200 ease-in-out
  placeholder-gray-400
  hover:border-pink-400 hover:shadow
`;

const SearchInput = ({ value, onChange }) => (
  <div className="relative group">
    <Search className="absolute left-3.5 top-1/2 transform -translate-y-1/2 text-gray-400 group-focus-within:text-pink-500 h-5 w-5 transition-colors" />
    <input
      type="text"
