...
//             const existingCandidate = await this.nonRailwayModel.getByTicketNumber(ticketNumber);
...
//             });
//         } catch (error) {
//             console.error('Error getting NonRailway candidates by designation:', error);
//             res.status(500).json({
//                 success: false,
...
//             });
//         } catch (error) {
//             console.error('Error getting NonRailway candidates by course type:', error);
//             res.status(500).json({
//                 success: false,
