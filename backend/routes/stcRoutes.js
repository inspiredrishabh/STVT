...
router.get("/:ticketNumber/sessions", (req, res) =>
  stcController.getSessionDates(req, res)
);

// PUT to add/update session-dates
router.put("/:ticketNumber/sessions", (req, res) =>
  stcController.updateSessionDates(req, res)
);
